...
#define FFMPEG_CONFIGURATION "--disable-programs --disable-shared --enable-static --enable-pic --enable-small --disable-postproc --disable-avdevice --enable-libfdk-aac --enable-libk264 --enable-libks265 --enable-libkvc19 --enable-libkvc17 --enable-libopus --enable-nonfree --enable-gpl --enable-ffmpeg --disable-encoders --enable-encoder=libfdk_aac --enable-encoder=libk264 --enable-encoder=libopus --enable-encoder=rawvideo --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=pcm_s16le --disable-decoders --enable-decoder=libfdk_aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=libks265 --enable-decoder=libkvc19 --enable-decoder=libkvc17 --enable-decoder=libopus --enable-decoder=mjpeg --enable-decoder=mp3 --enable-decoder=ac3 --enable-decoder=mpeg4 --enable-decoder=pcm_alaw --enable-decoder=pcm_f32be --enable-decoder=pcm_f32le --enable-decoder=pcm_f64be --enable-decoder=pcm_f64le --enable-decoder=pcm_lxf --enable-decoder=pcm_mulaw --enable-decoder=pcm_s16be --enable-decoder=pcm_s16be_planar --enable-decoder=pcm_s16le --enable-decoder=pcm_s16le_planar --enable-decoder=pcm_s24be --enable-decoder=pcm_s24daud --enable-decoder=pcm_s24le --enable-decoder=pcm_s24le_planar --enable-decoder=pcm_s32be --enable-decoder='pcm_*' --enable-decoder=png --enable-decoder=rawvideo --enable-decoder=yuv4 --enable-decoder=gif --disable-demuxers --enable-demuxer=aac --enable-demuxer=flv --enable-demuxer=kflv --enable-demuxer=h264 --enable-demuxer=image2 --enable-demuxer=image_bmp_pipe --enable-demuxer=image_jpeg_pipe --enable-demuxer=image_png_pipe --enable-demuxer=kuaishou_bfr --enable-demuxer=m4v --enable-demuxer=mjpeg --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=ac3 --enable-demuxer=mpegts --enable-demuxer=wav --enable-demuxer='pcm*' --enable-demuxer=hevc --enable-demuxer=avi --enable-demuxer=hls --enable-demuxer=concat --enable-demuxer=gif --enable-demuxer='ipod--enable-demuxer=wav' --disable-parsers --enable-parser=aac --enable-parser=h264 --enable-parser=hevc --enable-parser=mjpeg --enable-parser=mpegaudio --enable-parser=mpeg4video --enable-parser=opus --enable-parser=png --disable-muxers --enable-muxer=f4v --enable-muxer=flv --enable-muxer=live_flv --enable-muxer=h264 --enable-muxer=kuaishou_bfr --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=ipod --enable-muxer=wav --disable-filters --enable-filter=amix --enable-filter=amovie --enable-filter=anull --enable-filter=anullsink --enable-filter=apad --enable-filter=aresample --enable-filter=asetpts --enable-filter=asetrate --enable-filter=asplit --enable-filter=blend --enable-filter=concat --enable-filter=copy --enable-filter=crop --enable-filter=fps --enable-filter=framepack --enable-filter=framestep --enable-filter=gles --enable-filter=hflip --enable-filter=movie --enable-filter=nullsink --enable-filter=overlay --enable-filter=pad --enable-filter=rotate --enable-filter=scale --enable-filter=setpts --enable-filter=split --enable-filter=tblend --enable-filter=transpose --enable-filter=trim --enable-filter=vflip --enable-filter=volume --enable-filter=stereotools --enable-filter=yadif --disable-doc --enable-asm --enable-inline-asm --enable-protocol=hls --enable-protocol=concat --enable-protocol=pipe --prefix=/home/workspace/workspace/FFmpeg_Android/kuaishou-android-build/output/arm64-v8a --cross-prefix=/data/env/android-ndk/r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android- --cc=/data/env/android-ndk/r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang --cxx=/data/env/android-ndk/r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++ --ld=/data/env/android-ndk/r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang --target-os=linux --arch=aarch64 --cpu=cortex-a53 --enable-cross-compile --sysroot=/data/env/android-ndk/r20/platforms/android-21/arch-arm64 --extra-cflags='-fPIE -pie -fpic -I. -I/home/workspace/workspace/FFmpeg_Android/kuaishou-android-build/libs/include -I/data/env/android-ndk/r20/sysroot/usr/include -I/data/env/android-ndk/r20/sysroot/usr/include/aarch64-linux-android' --extra-ldflags=' -L/data/env/android-ndk/r20/sources/cxx-stl/llvm-libc++/libs/arm64-v8a -L/home/workspace/workspace/FFmpeg_Android/kuaishou-android-build/libs/arm64-v8a' --extra-libs='-llog -lc++_shared -lopus'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/home/workspace/workspace/FFmpeg_Android/kuaishou-android-build/output/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/home/workspace/workspace/FFmpeg_Android/kuaishou-android-build/output/arm64-v8a/share/ffmpeg"
...
#define CONFIG_LIBX264 0
#define CONFIG_LIBK264 1
#define CONFIG_LIBX265 0
#define CONFIG_LIBQY265 0
#define CONFIG_LIBKS265 1
#define CONFIG_LIBKVC19 1
#define CONFIG_LIBKVC17 1
...
#define CONFIG_LIBKS265_DECODER 1
#define CONFIG_LIBKVC19_DECODER 1
#define CONFIG_LIBKVC17_DECODER 1
...
#define CONFIG_LIBX264_ENCODER 0
#define CONFIG_LIBK264_ENCODER 1
#define CONFIG_LIBK264RGB_ENCODER 0
...
#define CONFIG_KWAILIVE_DEMUXER 0
#define CONFIG_KPHLS_DEMUXER 0
#define CONFIG_KPWEBRTC_DEMUXER 0
#define CONFIG_KPHLS_AEMON_DEMUXER 0
#define CONFIG_KPWEBRTC_AEMON_DEMUXER 0
...
#define CONFIG_KWAI_PROTOCOL 1
#define CONFIG_KPASYNC_PROTOCOL 1
#define CONFIG_KPHTTPHOOK_PROTOCOL 1
#define CONFIG_KPINJECT_PROTOCOL 1
#define CONFIG_KPLONGURL_PROTOCOL 1
#define CONFIG_KPMEDIADATASOURCE_PROTOCOL 1
#define CONFIG_KPSEGMENT_PROTOCOL 1
#define CONFIG_KPTCPHOOK_PROTOCOL 1
#define CONFIG_KPINDEXCONTENT_PROTOCOL 1
#define CONFIG_KPWEBRTC_PROTOCOL 1
#define CONFIG_KPFFMPEGDATASOURCE_PROTOCOL 1
#define CONFIG_KPASYNC_AEMON_PROTOCOL 1
#define CONFIG_KPHTTPHOOK_AEMON_PROTOCOL 1
#define CONFIG_KPINJECT_AEMON_PROTOCOL 1
#define CONFIG_KPLONGURL_AEMON_PROTOCOL 1
#define CONFIG_KPMEDIADATASOURCE_AEMON_PROTOCOL 1
#define CONFIG_KPSEGMENT_AEMON_PROTOCOL 1
#define CONFIG_KPTCPHOOK_AEMON_PROTOCOL 1
#define CONFIG_KPINDEXCONTENT_AEMON_PROTOCOL 1
#define CONFIG_KPWEBRTC_AEMON_PROTOCOL 1
#define CONFIG_KPFFMPEGDATASOURCE_AEMON_PROTOCOL 1
